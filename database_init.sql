...
--
-- Host: localhost    Database: zap-hostingesxpack_12f9b1
-- ------------------------------------------------------
...
INSERT INTO `addon_account` VALUES ('bank_savings','Bank Savings',0),('caution','caution',0),('property_black_money','Dirty Money Property',0),('society_ambulance','EMS',1),('society_banker','Banker',1),('society_cardealer','Cardealer',1),('society_mechanic','Mechanic',1),('society_police','Police',1),('society_realestateagent','Agent immobilier',1),('society_taxi','Taxi',1);
...
INSERT INTO `addon_account_data` VALUES (1,'society_cardealer',0,NULL),(2,'society_police',0,NULL),(3,'society_ambulance',0,NULL),(4,'society_mechanic',0,NULL),(5,'society_taxi',0,NULL);
...
CREATE TABLE `billing` (
  ...
  `sender` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `target` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `datastore_data` VALUES (1,'society_police',NULL,'{}'),(2,'society_ambulance',NULL,'{}'),(3,'society_mechanic',NULL,'{}'),(4,'society_taxi',NULL,'{}');
...
INSERT INTO `inventories` VALUES ('test',NULL,'\"something\"');
...
INSERT INTO `jobs` VALUES ('ambulance','EMS',0),('banker','Banker',0),('cardealer','Cardealer',0),('fisherman','Fisherman',0),('fueler','Fueler',0),('lumberjack','Lumberjack',0),('mechanic','Mechanic',0),('miner','Miner',0),('police','LSPD',0),('realestateagent','Real Estate Agent',0),('reporter','Reporter',0),('slaughterer','Butcher',0),('tailor','Tailor',0),('taxi','Taxi',0),('unemployed','Unemployed',0);
...
INSERT INTO `licenses` VALUES ('boat','Boat License'),('dmv','Traffic Laws'),('drive','Drivers license'),('drive_bike','Motorcycle licence'),('drive_truck','Truck license'),('weapon','Weapon License'),('weed_processing','Weed Processing License');
...
INSERT INTO `migrations` VALUES (1,'skin',0),(2,'society',0);
...
CREATE TABLE `owned_vehicles` (
  ...
  `vehicle` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `rented_vehicles` (
  `vehicle` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `plate` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `user_parkings` (
  ...
  `garage` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `zone` int NOT NULL,
  `vehicle` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `group` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'user',
  `inventory` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `job` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'unemployed',
  ...
  `accessories` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `last_property` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `vehicle_sold` (
  ...
  `soldby` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2022-02-20 19:55:23
